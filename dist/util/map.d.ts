...
import { Named, Positional } from "../core/types";
/**
 * Public API of the return value of the [[map]] resource.
 */
interface MappedArray<MappedTo> {
    /**
 ...
 * ```
 */
declare function map<Element = unknown, MapTo = unknown>(
/**
 ...
 * @private
 */
declare class TrackedArrayMap<Element = unknown, MappedTo = unknown> extends Resource<Args<Element, MappedTo>> implements MappedArray<MappedTo> {
    #private;
    [index: number]: MappedTo;
    private _records;
    private _map;
