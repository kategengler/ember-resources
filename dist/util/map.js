...
import { a as _classPrivateFieldGet } from '../classPrivateFieldGet-53072de4.js';
...
let TrackedArrayMap = (_class = (_map = /*#__PURE__*/new WeakMap(), _Symbol$iterator = Symbol.iterator, class TrackedArrayMap extends Resource {
  ...
  modify([data], {
    ...
    assert(`Every entry in the data passed ta \`map\` must be an object.`, data.every(datum => typeof datum === 'object'));
    this._records = data;
    this._map = map;
  }
  get length() {
